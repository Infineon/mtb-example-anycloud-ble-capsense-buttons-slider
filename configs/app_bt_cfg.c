 ...
 * Global variable
 ******************************************************************************/
/* Device Name with null-terminated*/
uint8_t BT_LOCAL_NAME[] = { 'C', 'a', 'p', 'S', 'e', 'n', 's', 'e',' ','S','e','r','v','e','r','\0' };
...
const wiced_bt_cfg_settings_t wiced_bt_cfg_settings =
{
    ...
    .ble_advert_cfg =
    {
        ...
        .high_duty_duration              = 60,                                                         /**< High duty undirected connectable advertising duration in seconds (0 for infinite) */
